...
describe("AssistantMessageItem", () => {
  ...
  describe("assistant messages", () => {
    it("should render assistant label with Intugle icon", () => {
      const message = createMessage({
        role: "assistant",
      ...
      expect(screen.getByText("Intugle Flow Assistant")).toBeInTheDocument();
      expect(screen.getByAltText("Intugle Flow Assistant")).toBeInTheDocument();
    });
  });
