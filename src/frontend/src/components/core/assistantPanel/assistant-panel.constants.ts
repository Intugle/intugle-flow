...
export const ASSISTANT_TITLE = "Intugle Flow Assistant";

export const ASSISTANT_SESSION_STORAGE_KEY_PREFIX =
  "intugle-assistant-session-";
...
export const ASSISTANT_SESSIONS_STORAGE_KEY = "intugle-assistant-sessions";
...
export const ASSISTANT_SUGGESTIONS: AssistantSuggestion[] = [
  ...
  },
  {
    id: "answer-questions",
    icon: "Sparkles",
    text: "Answer questions about Intugle Flow",
  },
];
